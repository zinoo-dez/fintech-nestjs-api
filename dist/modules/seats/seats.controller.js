...
const hold_seat_dto_1 = require("./dto/hold-seat.dto");
let SeatsController = class SeatsController {
    seatsService;
    constructor(seatsService) {
        this.seatsService = seatsService;
    }
    async holdSeat(seatId, holdSeatDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, hold_seat_dto_1.HoldSeatDto]),
    __metadata("design:returntype", Promise)
], SeatsController.prototype, "holdSeat", null);
